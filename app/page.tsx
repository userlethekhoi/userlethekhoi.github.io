...
import { Send, Mail, MapPin, Globe, Clock, CalendarDays, Camera, MessageCircle, Instagram, AtSign } from "lucide-react";
...
export default function Home() {
  const socialLinks = [
    ...
    { name: "Instagram", href: "https://www.instagram.com/tkhoi.lee_dev?igsh=MXd4M2VjeTNveWdxcA%3D%3D&utm_source=qr", icon: <Instagram className="w-5 h-5" />, color: "hover:bg-[#E1306C]" },
