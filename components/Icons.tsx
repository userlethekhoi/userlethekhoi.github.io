...
const SocialIcons: Record<string, string> = {
  ...
  Gmail: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 5.5A1.5 1.5 0 0 1 3.5 4h17A1.5 1.5 0 0 1 22 5.5v13a1.5 1.5 0 0 1-1.5 1.5h-17A1.5 1.5 0 0 1 2 18.5v-13Z" fill="#F2F2F2"/><mask id="gmail-m" maskUnits="userSpaceOnUse" x="2" y="4"><path d="M22 5.5v13a1.5 1.5 0 0 1-1.5 1.5h-17A1.5 1.5 0 0 1 2 18.5v-13A1.5 1.5 0 0 1 3.5 4h17a1.5 1.5 0 0 1 1.5 1.5Z" fill="#fff"/></mask><g mask="url(#gmail-m)"><path d="M2 6.7l10 7.5L22 6.7" stroke="#555" stroke-width="1.5" stroke-linecap="round"/><rect x="2.8" y="4.8" width="18.4" height="14.9" rx="1.5" fill="#EA4335"/><path d="M6.4 13.3v4.1l3.8-2.6-1.1-4.6-.9-2.3-.8 2.5-.9 2.9Z" fill="#fff"/><path d="m18.7 13.3-1.1 4.6 3.8 2.6v-4.1l-2.7-3.1Z" fill="#fff"/><path d="m14.8 13.3-3.5 5.7v-4.1l-2.7-1.6v4.3l6.2-4.3Z" fill="#fff"/><path d="m11.1 13.3-2.7 1.6v4.1l-3.5-5.7 6.2 4.3V10.2Z" fill="#fff"/><path d="M12.4 13.3v7.1l2.4-1.4v-4.3l-2.4-1.4Z" fill="#fff"/></g></svg>`,
  Hotmail: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="#0072C6"/><path d="M13.5 6H6L2 12l4 6h7.5a3.5 3.5 0 0 0 3.5-3.5V9.5A3.5 3.5 0 0 0 13.5 6Z" fill="#0072C6" stroke="#fff" stroke-width="1.2"/><path d="M13.5 6H2l4 6h7.5a3.5 3.5 0 0 0 3.5-3.5V6Z" fill="#00A4EF"/><path d="m22 12-9-6v5l4 3 4-3v-5L22 12Z" fill="#fff"/></svg>`,
